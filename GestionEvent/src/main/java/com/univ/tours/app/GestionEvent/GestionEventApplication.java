...
public class GestionEventApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Evenement e7 = evenementRepository.save(new Evenement("El Perro - El Lobo", "Combat","Combat de prison illégal", "Guantánamo",new Date(), 750, 100));
		...
		Evenement e9 = evenementRepository.save(new Evenement("Nadal - Djokovic", "Match","Finale du tournoi de Roland-Garros entre deux légendes", "Paris",new Date(), 1000, 12000));
		Evenement e10 = evenementRepository.save(new Evenement("Vikings : The movie", "Film","Retrouvez vos héros préférés au Valhalla !", "Canada",new Date(), 15, 1300));
		Evenement e11 = evenementRepository.save(new Evenement("Je suis Alvin", "Manifestation","Rejoignez la marche pour lutter contre le massacre des écureuils en Picardie !", "Paris",new Date(), 0, 200000));
		Evenement e12 = evenementRepository.save(new Evenement("Ezio’s Family Concert Suite", "Concert","Opéra tirée du jeu vidéo Assassin's Creed II et réalisé par le WDR Funkhausorchester", "Cologne",new Date(), 120, 7000));
